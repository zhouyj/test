...
//		this.allowFiles = this.getAllowFiles( conf.get("allowFiles") );
	...
	/*public State listFile (int index, String marker ) {
		...
		try {
			...
			for (com.qiniu.storage.model.FileInfo fileInfo : fileListing.items) {
